...
// 상징이 존재하는 지역 목록 (12개) - 타곤, 다르킨은 상징 없음
// 용도: 보유 지역 상징 UI, 제외할 지역 UI
...
// 지역 조합 생성용 지역 목록 (13개) - 다르킨만 제외
// 용도: 세계룬 시뮬레이터 지역 조합 생성
// 타곤은 상징은 없지만 지역 특성은 존재하므로 포함
export const CALCULABLE_REGIONS: string[] = [
  "공허",
  "그림자군도",
  "녹서스",
  "데마시아",
